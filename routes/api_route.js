...
router.get("/player-card/:address", async (req, res, next) => {
    await item_controller.getPlayerCard(req, res, next)
});
router.get("/player-gig/:address", async (req, res, next) => {
    await item_controller.getPlayerGig(req, res, next)
});
/**
...
router.get("/collection/detail/:name", async (req, res, next) => {
